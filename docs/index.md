...
| `docs/live-provider-proof/stripe-redaction-policy.md` | Evaluators, commercial operators, release managers | Redaction rules for public Stripe and GitHub proof samples. | Public-sample policy. It does not authorize sharing private live proof bundles. |
