...
| `docs/releases/v0.2.0-pilot.md` | Evaluators, release managers, commercial reviewers | Pilot prerelease notes, accepted pilot risks, known limitations, and validation commands. | Release-specific narrative. It is not production certification. |
