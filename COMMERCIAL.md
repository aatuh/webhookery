...
Webhookery is publicly available under the GNU Affero General Public License
...
Webhookery in proprietary products, private SaaS systems, closed internal
...
| Offer | Customer hosts? | Webhookery hosts? | Notes |
| --- | ---: | ---: | --- |
